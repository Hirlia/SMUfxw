...
*/
class CVertex : public Vertex<CUsedTypes, vertex::BitFlags, vertex::Coord3f, vertex::Normal3f, vertex::Mark>
{
};
...
class MyPolyVertex : public vcg::Vertex<PolyUsedTypes, vcg::vertex::Coord3f, vcg::vertex::Normal3f, vcg::vertex::Mark,
                                        vcg::vertex::BitFlags, vcg::vertex::VHAdj>
{
};
...
class CHEdge : public HEdge<PolyUsedTypes, hedge::BitFlags,
                            ...
                            hedge::HEdgeData  // the previous 4 components (just more handy, you can comment this and
                                              // uncomment the previous four lines)
...
class MyPolyFace
  : public vcg::Face<PolyUsedTypes, vcg::face::PolyInfo  // this is necessary  if you use component in
                     ...
                     ,
                     vcg::face::PFVAdj, vcg::face::PFFAdj  // Pointer to edge-adjacent face (just like FFAdj )
                     ,
...
class MyPolyMesh : public vcg::tri::TriMesh<std::vector<MyPolyVertex>,  // the vector of vertices
