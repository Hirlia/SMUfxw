...
void NormalSmoother::runAnisotropicPCA()
{
    ...
    AnistropicPca<vector<CVertex> >::ComputeAPcaNormalsByKNN(mesh->vert.begin(), mesh->vert.end(), 10, radius,
                                                             para->getDouble("Sharpe Feature Bandwidth Sigma"));
}
