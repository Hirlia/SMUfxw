...
void Upsampler::other_optimize_upsamples_global(CGrid::iterator starta, CGrid::iterator enda, CGrid::iterator startb,
...
void Upsampler::other_optimize_normals(CGrid::iterator starta, CGrid::iterator enda, CGrid::iterator startb,
                                       CGrid::iterator endb, double radius)
{
    double radius2 = radius * radius;
    double iradius16 = -4 / radius2;
