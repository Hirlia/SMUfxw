...
bool ReadShotFromQDomNode(ShotType &shot,        /// the shot that will contain the read node
...
template <class ShotType>
QDomElement WriteShotToQDomNode(const ShotType &shot,  /// the shot to be written node
